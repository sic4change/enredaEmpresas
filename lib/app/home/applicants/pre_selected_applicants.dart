...
class PreSelectedApplicantsListPage extends StatefulWidget {
  const PreSelectedApplicantsListPage({Key? key}) : super(key: key);

  @override
  State<PreSelectedApplicantsListPage> createState() => _PreSelectedApplicantsListPageState();
}

class _PreSelectedApplicantsListPageState extends State<PreSelectedApplicantsListPage> {
      ...
      child: Column(
        ...
        children: [
          StreamBuilder<List<JobOfferApplication>>(
            stream: database.preSelectedApplicationsByJobOffer(resource.jobOfferId!),
